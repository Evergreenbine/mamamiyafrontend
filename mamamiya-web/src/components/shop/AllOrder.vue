  ...
  <div>
      <div class="bigbox max-width margin-auto">
          <div class="barnav">
            ...
            <div class="barnavitem" :class="{avbar:page == 1}" @click="nopay(1,1)">待支付</div>
            <div class="barnavitem" :class="{avbar:page == 2}" @click="nopay(2,3)">待发货</div>
            <div class="barnavitem" :class="{avbar:page == 3}" @click="nopay(3,4)">待收货</div>
            <div class="barnavitem" :class="{avbar:page == 4}" @click="nopay(4,5)">交易完成</div>
            <div class="barnavitem" :class="{avbar:page == 5}" @click="nopay(5,6)">已关闭</div>
          </div>
      </div>
    <!-- 外面导航对应的大框 -->
      <div v-for="(item,i) in 6" :key="i" v-show="page == i" class="bigbigbox max-width margin-auto" >
          <!-- 里面的订单框 -->
          <div class="orderbox" v-for="(oditem,j) in od" :key="j">
              ...
              <div class="tailinfo">
                  ...
                  <div class="okbutton" @click="updatestate(5,oditem)" v-show="oditem.state == 2 || oditem.state == 3 || oditem.state == 4 ">确认收货</div>
                  <div class="okbutton" @click="updatestate(8,oditem)" v-show="oditem.state == 5">申请退货</div>
